...
const stores: Array<{ name: string; googleMapsUrl: string; placeId: string; type: string; brand: string }> = [
  ...
  { name: 'アメモバ 新宿東南口店', googleMapsUrl: 'https://www.google.com/maps/place/?q=place_id:ChIJa8SgWUWNGGARl2Fnx36y2JU', placeId: 'ChIJa8SgWUWNGGARl2Fnx36y2JU', type: 'DIRECT', brand: 'AMEMOBA' },
